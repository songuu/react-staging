  ...
  fs.copy(templatePath, projectDir)
    .then(() => {
      ...
      const packageJson = JSON.parse(
        fs.readFileSync(`${projectDir}/package.json`, "utf-8")
      );
      ...
      const versions = {
        ...
        // "react-dom": packageJson.dependencies["react-dom"].replace("^", ""),
        // "react-router-dom": packageJson.dependencies["react-router-dom"].replace("^", ""),
